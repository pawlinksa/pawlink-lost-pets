...
firebaseAdmin.initializeApp({
  credential: firebaseAdmin.credential.cert(require('./serviceAccountKey.json')), // Use the correct path to your .json file
...
<body>
  ...
  fs.writeFile(filePath, tagPageContent, (err) => {
    ...
    res.send(`File created: <a href="/${tagNumber}.html" download>Download</a>`);
  });
});
